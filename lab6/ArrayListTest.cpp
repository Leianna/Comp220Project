...
//std::cout<<myList2.toString()<<std::endl;
        myList2.insertAt(33, i);
    }
    printAssertEquals("{33, 9, 33, 8, 33, 7, 33, 6, 33, 5, 33}", myList2.toString());
    printAssertEquals(false, myList2.isEmpty());
    printAssertEquals(11, myList2.itemCount());
